...
<p align="center">
  <a href="https://devtools.at/tools/hmac-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate HMAC signatures</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/hmac-generator">Try Online</a> •
...
**[Try HMAC Generator online at DevTools.at →](https://devtools.at/tools/hmac-generator)**
...
Generate HMAC signatures. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/hmac-generator';
